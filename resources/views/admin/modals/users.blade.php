    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-red-500">Apagando esse usuário você estará apagando tambem todos os processos que
                    pertence a esse usuário.</p>
            </div>
...
<script>
    function exibirModalExclusao(id) {
        ...
        var rota = "{{ route('users.destroy', ['user' => ':id']) }}";
